package com.b2wdigital.selecao.peopleregistration.controller.exception;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<StandardError> constraintViolationException (DbException e, HttpServletRequest request){
